...
class Thumbnail extends Images {

    public function __construct($name = null, $type = null,
                                $tmpFileUrl = null, $size = null,
                                $height = null, $width = null, $urlOnDiskPicture = null,
                                $urlOnDiskThumb = null, $newName = null, $extension = null)
    {
        parent::__construct($name, $type, $tmpFileUrl, $size,
            $height, $width, $urlOnDiskPicture, $urlOnDiskThumb,
            $newName, $extension);
    }
